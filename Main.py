...
if __name__ == '__main__':
    ...
    binarized_grey_image = ImageObject()
...
# ================================================================================#
    ...
    binarized_grey_image = enhancement.binarization(img_object)

    img_object.set_image_name("grey scale {}".format(img_object.get_image_name()))
    i_writer.write_image(img_object)

    char_splitter.split_image(binarized_grey_image)  # split a word into characters
